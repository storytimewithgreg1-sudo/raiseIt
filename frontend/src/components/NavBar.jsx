...
const NavBar = () => {
  return (
    <div className="flex justify-between p-5 border-b border-white/30 items-center mb-10">
          ...
          <Link to='/create'>
            <button className="btn border-purple-600/50 text-sm hover:border-none bg-linear-to-r from-blue-600 to-purple-600 btn-xs text-xs md:btn-md md:text-md text-white">Create Classroom</button>
          </Link>
